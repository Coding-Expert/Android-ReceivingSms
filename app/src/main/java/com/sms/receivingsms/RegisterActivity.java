...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register_button.setOnClickListener(register_listener);
...
//                    device_imei = tMgr.getImei();
    ...
    public void moveToReceivingScreen(){
        Intent intent = new Intent(RegisterActivity.this, ReceivingSmsActivity.class);
